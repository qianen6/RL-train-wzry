...
class TrainingConfig:
    ...
    LOSS_IMAGE_PATH='../loss_image/loss_curve.png'
    LOSS_IMAGE_DIR='../runs/experiment'
    EXPERIENCES_FILEPATH="../experiences/experience1/"#经验文件存放路径
    left_action_states = spaces.Discrete(9)
    right_action_states = spaces.Discrete(8)