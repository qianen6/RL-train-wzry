...
class StateVector:
    ...
    def update(self, frame):
        ...
        self.state_vector["isDead"] = self.is_dead(frame)
        self.state_vector["isEnemyBloodChanged"] = self.is_enemy_blood_changed(frame)
        self.state_vector["isVictory"] = self.is_victory(frame)
        self.state_vector["isDefeat"] = self.is_defeat(frame)
        self.state_vector["isTowerAttacking"] = self.is_tower_attacking(frame)
        self.state_vector["isAtDest"] = self.routing_guide.is_at_any_destination(frame, current_pos)
        self.state_vector["isAttackingMonster"] = self.routing_guide.detect_any_monster(frame)
        self.state_vector["selfBlood"] = self.get_self_blood(frame)
        self.state_vector["enemyBlood"] = self.get_enemy_blood(frame)
        self.state_vector["economicValue"] = self.get_economic_value(frame)
        self.state_vector["selfKillsValue"] = self.get_self_kills_value(frame)
